...
import com.competitions.services.PersonService;
...
public class PersonServiceTests extends DataContainer {
    ...
    public Person getAndCheckPersonData(String nickName, PersonService personService, Map<String, String> personMap,
                                        Map<String, Integer> passportMap, String... phoneNums) {
        Person person = personService.getByNickName(nickName);
